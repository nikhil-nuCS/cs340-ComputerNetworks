...
def start_scan(file_name, output_filename):
    # JSON dictionary to store all the websites and their requested details
    json_dict = {}
    file_content = get_file_content(file_name)
    
    # Open and read the content of Geolocation DB provided
...
def write_to_file(json_content, output_filename):
    # Write to file provided in the system arguments
...
if __name__ == '__main__':
    ...
    # Check if the file exists and proceed with the program
